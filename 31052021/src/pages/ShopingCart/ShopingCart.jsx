...
const ShoppingCart = (props) => {
     //console.log(props.isProductUpdated);
    let isProductUpdated = (props.isProductUpdated) 
    return (
        <>
            <div className="container" style={{ paddingTop: '6rem' }}>
                <div className="card shopping-cart">
                    <div className="border text-success">{isProductUpdated}</div>
...
const mapStateToProps = state => {
    ...
    return {
        ...
        isProductUpdated: state.shop.productUpdated
    }
}
